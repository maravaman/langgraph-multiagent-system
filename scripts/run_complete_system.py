...
def test_direct_framework():
    ...
    try:
        ...
        # Test waterfall photography in Norway
...
def test_memory_system():
    ...
    try:
        ...
        memory.set_stm("test_user", test_key, "Test memory value", 3600)
        retrieved = memory.get_stm("test_user", test_key)
        print(f'✅ STM Test: {retrieved}')
        
        # Test LTM
        memory.set_ltm("test_user", test_key, "Test LTM value")
        ltm_data = memory.get_ltm_by_agent("test_user", test_key)
